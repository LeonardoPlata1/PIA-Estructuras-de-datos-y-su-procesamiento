...
diccionario_notas = {"Crescencio": [87,100, None],"Domitila":[80,None,57], \
                     "Rutilla":[80,70,57],"Panfilo":[20,100,100],"Ludoviko":[100,100,100]}

notas_diccionaro = pd.DataFrame(diccionario_notas)
print(notas_diccionaro)
print(SEPARADOR)
...
notas_diccionaro = pd.DataFrame(diccionario_notas_aleatorias)
print(notas_diccionaro)
print(SEPARADOR)
